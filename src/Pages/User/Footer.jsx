    ...
    <footer className="bg-gradient-to-r from-gray-900 to-black text-white py-10 px-4 z-[999]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-6 mt-6 md:mt-0">
          <a
            href="https://github.com/Gourav12321"
          ...
          <a
            href="https://www.linkedin.com/in/gourav-maurya-1b516a303/"
            className="text-gray-400 hover:text-white "
            target="blank"
          >
            <FaLinkedin size={25} />
          ...
          <a
            href="https://www.instagram.com/gourav_maurya426/"
            className="text-gray-400 hover:text-white "
            target="blank"
          >
            <FaInstagram size={25} />
        ...
        <div className="mt-6 md:mt-0 text-gray-400 text-sm">
          <p>
            © {new Date().getFullYear()} Gourav Maurya. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
