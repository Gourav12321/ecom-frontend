...
const Dashboard = () => {
  ...
  const orderStatusData = {
    labels:
      dashboardData.orderStatusBreakdown?.map((status) => status._id) || [],
    datasets: [
      {
        data:
          dashboardData.orderStatusBreakdown?.map((status) => status.count) ||
          [],
        backgroundColor: [
          "#FF6384",
          "#36A2EB",
  ...
  return (
    <div className="dashboard w-full p-4  lg:p-8">
      <h1 className="text-xl lg:text-2xl pt-[50px] lg:pt-8 font-bold mb-6 text-center lg:text-left">
        Admin Dashboard
      </h1>
      ...
      <div className="dashboard-stats grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6 mb-6">
        ...
        <div className="stat bg-white p-4 rounded-lg shadow-md text-center">
          ...
          <p className="text-xl lg:text-2xl font-bold">
            Rs.{Math.round(dashboardData.totalRevenue)}
          </p>
        </div>
        <div className="stat bg-white p-4 rounded-lg shadow-md text-center">
          <h3 className="text-md lg:text-lg font-semibold mb-2">
      ...
      <div className="dashboard-charts grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        <div className="chart bg-white p-4 rounded-lg shadow-md">
          <h3 className="text-md lg:text-lg font-semibold mb-4 text-center">
